...
function getRandomCharNear(char) {
  const keyboardMap = {
    a: "qwsz",
    b: "vghn",
    c: "xdfv",
...
export function getHumanTypingSequence(text) {
...
export function getKeyboardPressDelay() {
  return Math.floor(randomInRange(80, 120));
}
export function getHumanKeypressSequence(keys) {
